...
namespace PosWeb.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "GetSalesOutputs",
                columns: table => new
                {
                    SalesOutputId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GetSalesOutputs", x => x.SalesOutputId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesDetail_GetSalesOutputs_SalesOutputId",
                        column: x => x.SalesOutputId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesDetail_SalesOutputId",
                table: "SalesDetail",
